...
echo"<div class='container-fluid'>
		<!-- Page Heading -->
		<h1 class='h3 mb-2 text-gray-800'>Data Users Account</h1>
		<div class='card shadow mb-4'>
			<div class='card-header py-2'>
				<div class='float-right'>"; 
				if ($cek['tambah']=='1')
				{ 
					echo"<button class='btn btn-primary btn-sm' onclick='add_users()'><small><i class='fas fa-plus'></i> Add Data</small></button>"; 
       ...
       // url : "<?php echo site_url('users/ajax_edit')?>/" + id,
        ...
        success: function(data)
        {
            ...
            if(data.foto)
            {
                ...
                $('#gambar-preview div').html('<img src="'+base_url+'assets/foto_user/'+data.foto+'" class="img-fluid img-thumbnail" width="30%">'); // show gambar
        ...
        <div class="modal-content">
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    <input type="hidden" value="" name="id_users"/> 
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3">Username</label>
                            <div class="col-md-12">
                                <input name="username" placeholder="Isi Username" class="form-control" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input name="password" placeholder="Isi Password" class="form-control" type="password">
                                <span class="help-block text-danger"></span>
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input name="nama_lengkap" placeholder="Isi Nama Lengkap" class="form-control" type="text">
                                <span class="help-block text-danger"></span>
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input name="email" placeholder="Isi Email" class="form-control" type="text">
                                <span class="help-block text-danger"></span>
                            </div>
                        </div>
						...
						<option value="0">--Select Roles--</option>
								...
								<option value="<?php echo $a->id_role; ?>"><?php echo $a->nm_role; ?></option>
								<?php } ?>
						</select>
                                <span class="help-block text-danger"></span>
                            </div>
