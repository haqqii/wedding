<?php
  $cek = user_akses2('photo_pria',$this->session->level);
   if ($cek['tampil']=='1'){
echo"<div class='container-fluid'>
		<!-- Page Heading -->
		<h1 class='h3 mb-2 text-gray-800'>Photo Mempelai Pria</h1>
		<div class='card shadow mb-4'>
			...
			";
          echo'<form method="post" role="form" action="'.base_url().'photo_pria" enctype="multipart/form-data">
                  <div class="row">
				  <div class="col-sm-12">
                ...
                <p class="font-italic ">*Upload dengan Ukuruan 600x600 Pixel</p> 
						<input type="file" class="form-control" name="photo_pria" value="'.$record['photo_pria'].'">
						<br/>
						Current Image : <br/><img src="'.base_url().'assets/front_image/'.$record['photo_pria'].'" class="img-thumbnail">
